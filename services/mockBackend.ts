import { Product, User, UserRole, Order, OrderStatus, SalesStat } from '../types';
...
const MOCK_USERS: User[] = [
  { id: 'admin1', name: 'Admin User', email: 'admin@tinhme.com', role: UserRole.ADMIN, avatar: 'https://i.pravatar.cc/150?u=admin' },
  { id: 'user1', name: 'John Doe', email: 'user@tinhme.com', role: UserRole.CUSTOMER, avatar: 'https://i.pravatar.cc/150?u=user' }
];
...
class MockBackendService {
  ...
  // Analytics
  getSalesReport(): Promise<SalesStat[]> {
    const data = [
      { name: 'Jan', sales: 4000 },
      { name: 'Feb', sales: 3000 },
      { name: 'Mar', sales: 2000 },
  ...
  signup(name: string, email: string, role: UserRole = UserRole.CUSTOMER): Promise<User> {
      const newUser: User = {
